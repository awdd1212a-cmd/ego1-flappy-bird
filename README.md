...
下一階段主要是上板驗證新版視覺與遊戲手感。VGA to HDMI 轉換器與擷取卡已確認可以收到 EGO1 輸出的彩條畫面，top_vga 也已能顯示遊戲場景。

建議實作順序：

1. 使用 C:/ego1_top_vga_build/bitstream/top_vga.bit 燒錄新版 top_vga
2. 確認 OBS 畫面中鳥是否能看出嘴巴、眼睛、翅膀
3. 測試 start / flap / game over 的實際操作手感
