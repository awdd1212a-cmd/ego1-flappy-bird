# ============================================================
# EGO1 VGA Reference Constraints
# For VGA renderer / top integration reference
#
# Usage:
# Copy the VGA section you need into the active XDC file.
#
# Recommended top-level VGA port names:
...
#
# Note:
# Port names in XDC must match Verilog top module names exactly.
# Vivado is not a mind reader, despite how much pain it causes.
# ============================================================
...
# ============================================================
# Optional: Buttons used by current game logic
# ============================================================
